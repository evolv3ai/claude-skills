...
_Consolidated from `skills/admin-devops (kasm)` on 2026-02-02_
...
- `admin-devops (provider reference)` for OCI/Hetzner/etc server setup.
...
```bash
cd .claude/skills/admin-devops (kasm)
...
```
.claude/skills/admin-devops (kasm)/
...
- **Skill Documentation**: `.claude/skills/admin-devops (kasm)/SKILL.md`
