...
|--------|-------------|-------|
| Coolify | Self-hosted PaaS (Heroku alternative) | admin-app-coolify |
| KASM Workspaces | Browser-based VDI | admin-app-kasm |
...
Ask the following (from admin-app-coolify Step 0):
...
Ask the following (from admin-app-kasm Step 0):
...
Load the appropriate admin-app-* skill and execute.

Reference the app's SKILL.md for exact steps:
- Coolify: `skills/admin-app-coolify/SKILL.md`
- KASM: `skills/admin-app-kasm/SKILL.md`
