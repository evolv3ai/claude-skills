...
|--------|-------------|-------|
| OCI (Oracle Cloud) | Free ARM64 tier available | admin-infra-oci |
| Hetzner | Best price/performance | admin-infra-hetzner |
| Contabo | Budget VPS, great value | admin-infra-contabo |
| DigitalOcean | Simple, reliable | admin-infra-digitalocean |
| Vultr | Global data centers | admin-infra-vultr |
| Linode (Akamai) | Kubernetes focus | admin-infra-linode |
...
Load the appropriate admin-infra-* skill and execute.

Reference the provider's SKILL.md for exact commands:
- OCI: `skills/admin-infra-oci/SKILL.md`
- Hetzner: `skills/admin-infra-hetzner/SKILL.md`
- etc.
