...
- [Cloudflare Tunnel Setup Script](.claude/skills/admin-app-coolify/scripts/coolify-cloudflare-tunnel-setup.sh)
- [Coolify Installation Guide](.claude/skills/admin-app-coolify/SKILL.md)
- [OCI Infrastructure Details](.claude/skills/admin-infra-oci/scripts/.env)
